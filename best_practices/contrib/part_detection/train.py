...
Usage:
    ...
    python3 train.py --data ./data/mycoco.yaml --cfg yolov5s.yaml --weights yolov5s.pt --img 640 --device 2 --batch-size 32
...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if RANK in [-1, 0]:
            ...
            torch.save(ckpt, opt.checkpoint)
            print('ckpt saved...')
...
def parse_opt(known=False):
    ...
    # checkpoint
    parser.add_argument('--checkpoint', type=str, default='yolov5.pt')
...
def main(opt, callbacks=Callbacks()):
    ...
    # Evolve hyperparameters (optional)
        ...
        meta = {'lr0': (1, 1e-6, 1e-1),  # initial learning rate (SGD=1E-2, Adam=1E-3)
