...
**This README file provides only guidance for running the sample in command line (CLI) mode. For details about how to run the sample in MindStudio, see [Running Video Samples in MindStudio](https://gitee.com/ascend/samples/wikis/Mindstudio%20running%20sample%20guide/Running%20Video%20Samples%20in%20MindStudio).**
...
2. Obtain the source model required by the application.
    ...
    | ----------------- | ------------------------------------- | ------------------------------------------------------------ |
    | yolo3_resnet18.pb | TensorFlow-YOLOV3-based mask detection model.| Download the model file and configuration file by referring to [README.md](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/yolov3_resnet18/ATC_yolo3_resnet18_tf_AE). |
