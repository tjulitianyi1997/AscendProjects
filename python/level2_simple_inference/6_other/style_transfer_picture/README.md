...
2. Obtain the source model required by the application.
    ...
    |---|---|
    | GAN-based model. |  Download the model and weight file by referring to the links in **README.md** in the [TensorFlow_contrib_cv_style_transfer](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/style_transfer) directory of the ModelZoo repository.|
