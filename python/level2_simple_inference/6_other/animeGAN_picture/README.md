...
2. Obtain the source model required by the application.
    ...
    |---|---|---|
    | AnimeGAN | Converts common images to cartoon images.  | Download the original model by referring to the links in **README.md** in the [**AnimeGAN**](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/AnimeGAN/README.MD) directory of the ModelZoo repository. |
    ```
