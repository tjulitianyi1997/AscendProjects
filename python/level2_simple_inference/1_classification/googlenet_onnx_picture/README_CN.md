...
2. 获取此应用中所需要的原始网络模型。
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    |  googlenet | 图片分类推理模型。是基于pytorch的GoogLeNet模型。  |  请参考[https://gitee.com/ascend/ModelZoo-PyTorch/tree/master/PyTorch/contrib/cv/classification/GoogleNet_ID1623_for_PyTorch/ATC_googlenet_pth_AE](https://gitee.com/ascend/ModelZoo-PyTorch/tree/master/PyTorch/contrib/cv/classification/GoogleNet_ID1623_for_PyTorch/ATC_googlenet_pth_AE)目录中README.md下载原始模型章节下载模型和权重文件。 |
