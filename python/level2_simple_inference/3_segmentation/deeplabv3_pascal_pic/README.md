...
2. Obtain the source model required by the application.
    ...
    |---|---|---|
    | DeepLabv3+| An inference model for semantic segmentation| Download the model by referring to [https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/deeplab-v3-plus](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/deeplab-v3-plus).|
    ```
