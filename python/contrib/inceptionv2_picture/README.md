...
2. Obtain the source model required by the application.
    ...
    | ------------ | ---------------------------------------- | ------------------------------------------------------------ |
    | InceptionV2  | TensorFlow framework, image classification inference model| Download the original model and model weight file by referring to [README.md](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/inceptionv2/ATC_inceptionV2_tf_AE). |
    ```
