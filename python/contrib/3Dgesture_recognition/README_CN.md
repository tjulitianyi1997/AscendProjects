...
2. 获取此应用中所需要的原始网络模型。
    |  **模型名称**  |  **模型说明**  |  **模型下载路径**  |
    |---|---|---|
    |  3DCNN| 	3D动作识别模型。是基于tensorflow的3DCNN模型。  |  请参考[https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/3dcnn/ATC_3DCNN_tensorflow_AE](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/3dcnn/ATC_3DCNN_tensorflow_AE)目录中README.md下载原始模型章节下载模型和权重文件。 |
    ```
