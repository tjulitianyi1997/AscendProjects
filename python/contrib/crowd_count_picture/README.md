...
2. Obtain the source network model required by the application.
    ...
    | ------------------ | ----------------------------- | ------------------------------------------------------------ |
    | count_person.caffe | Crowd counting based on Caffe.| Download the model and .cfg files by referring to the links in **README.md** in the [ATC_count_person_caffe_AE](https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/crowdCount/ATC_count_person_caffe_AE) directory.|
    ```
