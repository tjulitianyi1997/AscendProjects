...
# Modify yaml.load to adapt to pyyaml 5.4.0 or later
python3 file_operator.py --file ${SAMPLE_SRC_DIR}/python_tools/fast_rcnn/config.py --replace --content --all "yaml.load" --dest "yaml.safe_load"
python3 file_operator.py --file ${SAMPLE_SRC_DIR}/python_tools/rpn/proposal_layer.py --replace --content --all "yaml.load" --dest "yaml.safe_load"
