#ifndef __UdpScene_H_
#define __UdpScene_H_
...
class UdpScene : public rclcpp::Node
{
public:
    // 构造函数,有一个参数为节点名称
    UdpScene(std::string name);
...
private:
    ...
    rclcpp::Publisher<geometry_msgs::msg::Pose>::SharedPtr vision_target_publisher;
    ...
    float x_scale, y_scale, z_scale,x_pre,y_pre,z_pre;
