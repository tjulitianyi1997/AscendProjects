...
public:
    ...
    int request_();
    void server_callback_(rclcpp::Client<wheeltec_mic_msg::srv::GetOfflineResultsrv>::SharedFuture msg);
...
private:
    ...
    rclcpp::Client<wheeltec_mic_msg::srv::GetOfflineResultsrv>::SharedPtr Call_Client_;
