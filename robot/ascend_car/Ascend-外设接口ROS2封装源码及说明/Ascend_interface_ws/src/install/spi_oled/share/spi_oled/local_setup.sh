...
: ${AMENT_CURRENT_PREFIX:="/root/interface_ws/src/install/spi_oled"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/spi_oled/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/spi_oled/environment/path.sh"
