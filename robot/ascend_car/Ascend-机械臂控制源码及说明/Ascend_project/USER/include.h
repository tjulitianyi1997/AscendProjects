...
#define GET_U32_BYTE(T, idx) (T >> (idx * 8)) & (~0xFFFFFF00)
#define GET_U16_BYTE(T, idx) (T >> (idx * 8)) & (~0xFF00)

#define SET_U32_BYTE(T, idx, val) ( (T & (~(((U32)(0x000000FF)) << (idx * 8)))) | (((U32)val & (~0xFFFFFF00)) << (idx * 8)))
#define SET_U16_BYTE(T, idx, val) ( (T & (~(((U16)(0x00FF)) << (idx * 8)))) | (((U16)val & (~0xFF00)) << (idx * 8)))
