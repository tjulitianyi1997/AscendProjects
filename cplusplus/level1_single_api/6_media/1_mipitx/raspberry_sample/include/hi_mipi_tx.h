...
#define HI_ATTRIBUTE __attribute__((aligned(HI_ALIGN_NUM)))
...
typedef struct {
    ...
    const unsigned char HI_ATTRIBUTE *cmd;
} cmd_info_t;
...
typedef struct {
    ...
    unsigned char       HI_ATTRIBUTE *get_data;      /* read data memory address, should  malloc by user */
} get_cmd_info_t;
...
#define HI_MIPI_TX_COLORBAR     _IO(HI_MIPI_TX_IOC_MAGIC, 0x06)

#ifdef __cplusplus
}
#endif

#endif /* end of #ifndef __HI_MIPI_TX_H__ */
