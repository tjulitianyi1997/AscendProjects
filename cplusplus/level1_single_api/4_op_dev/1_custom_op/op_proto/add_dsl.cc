...
bool InferShapeAndTypeAddDsl(Operator& op, const string& input_name1, const string& input_name2, const string& output_name) {
...
{
  if(InferShapeAndTypeAddDsl(op, "x1", "x2", "y")) {
     return GRAPH_SUCCESS;
  }
  return GRAPH_FAILED;
}
