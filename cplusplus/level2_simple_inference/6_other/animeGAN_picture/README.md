...
2. Convert the model. 
    ...
    |---|---|---|
    | AnimeGAN | Converts a common image to an animated image. | For details about how to download the original model, see https://gitee.com/ascend/ModelZoo-TensorFlow/tree/master/TensorFlow/contrib/cv/AnimeGAN/README.MD. |
    ```
